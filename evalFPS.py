...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Test RT-DETR OBB model performance.")
    # parser.add_argument('--weights', type=str,default='/home/zjj/baseLineCode/ultralytics-main/runs/obb/a_best.pt', help='trained weights path')
    parser.add_argument('--weights', type=str,default='/home/zjj/baseLineCode/ultralytics-main/runs/obb/light.pt', help='trained weights path')
    # default = '/home/zjj/baseLineCode/ultralytics-main/runs/obb/rtdetr-l-best.pt', help = 'trained weights path')
    # default = '/home/zjj/baseLineCode/ultralytics-main/ultralytics/runs/fusionExperiments/Deconv.pt', help = 'trained weights path')
    # default = '/home/zjj/baseLineCode/ultralytics-main/ultralytics/runs/fusionExperiments/DualFusion.pt', help = 'trained weights path')
    # default = '/home/zjj/baseLineCode/ultralytics-main/ultralytics/runs/fusionExperiments/HSFPB.pt', help = 'trained weights path')
    # default = '/home/zjj/baseLineCode/ultralytics-main/ultralytics/runs/obb/train49/weights/best.pt', help = 'trained weights path')
    # parser.add_argument('--weights', type=str, default='/home/zjj/mamba-l-best.pt', help='trained weights path')
    ...
    parser.add_argument('--testtime', default=200, type=int, help='test iterations for latency')
