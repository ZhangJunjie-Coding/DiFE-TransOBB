...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str,
                        default='./ultralytics/cfg/models/rt-detr/rtdetr-l-DEConv-RepC3_WTConv.yaml', help='model.yaml')
    ...
    if opt.line_profile:  # profile layer by layer
        ...
        results = profile(input=im, ops=[model], n=3, device=device)
        print(results)
    ...
    else:  # report fused model summary (only for YOLOv5)
