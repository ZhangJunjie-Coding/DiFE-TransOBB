...
def get_flops(model, imgsz=640):
    ...
    try:
        # Profile at full resolution for accurate FLOPs calculation
        # Note: stride-based profiling was removed because it causes NaN in models
        # with WTConv2d or other ops that can't handle tiny (1×1) feature maps.
