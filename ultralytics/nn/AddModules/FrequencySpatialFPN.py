...
#         min_offset = (branch_offsets - branch_offsets.floor()).view(b, self.branches, 1, 1).expand(b, self.branches, h,
#                                                                                                    w)
#         max_offset = (branch_offsets.ceil() - branch_offsets).view(b, self.branches, 1, 1).expand(b, self.branches, h,
#                                                                                                   w)
#         offset = self.softmax(torch.cat([min_offset, max_offset], dim=1)).split(self.branches, dim=1)
#         min_offset = offset[0]
#         max_offset = offset[1]
#         for i in range(self.branches):
#             y[:, i, ...] = (torch.gather(branch_tensors, 1, branch_min[:, i, ...].unsqueeze(1)).squeeze(1) * min_offset[
#                 :, i, ...]
#                             + torch.gather(branch_tensors, 1, branch_max[:, i, ...].unsqueeze(1)).squeeze(1) *
#                             max_offset[:, i, ...])
#
#         return y.sum(1)
#
...
#             DCT2DSpatialTransformLayer(80, 80),
#             # SElayer(256,16),
#             # GroupAttentionlayer(64 * 64, 32),
#             # SelectGroupFClayer(64 * 64),
#             SelectGroupFClayer(80 * 80),
#             # SpatialFCAttentionlayer(64*64, 16),
#             # IDCT2DSpatialTransformLayer(64, 64)
#             IDCT2DSpatialTransformLayer(80, 80)
#         )
#         self.DCTDenoAttention1 = nn.Sequential(
#             DCT2DSpatialTransformLayer(40, 40),
#             # DCT2DSpatialTransformLayer(32, 32),
#             # SElayer(256,16),
#             # GroupAttentionlayer(32 * 32, 32),
#             # SelectGroupFClayer(32 * 32),
#             SelectGroupFClayer(40 * 40),
#             # SpatialFCAttentionlayer(32*32, 16),
#             # IDCT2DSpatialTransformLayer(32, 32)
#             IDCT2DSpatialTransformLayer(40, 40)
#         )
#
