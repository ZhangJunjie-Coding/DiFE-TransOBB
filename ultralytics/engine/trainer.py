...
from ultralytics.utils.visualizeutils import visualizeImg
import cv2
import numpy as np
import torch
...
class BaseTrainer:
    ...
    def _do_train(self, world_size=1):
        torch.autograd.set_detect_anomaly(True) # 反向传播中 NaN、inf、梯度问题定位
        ...
        while True:
            ...
            if RANK in {-1, 0}:
                LOGGER.info(self.progress_string()) # 输出日志 Epoch    GPU_mem  giou_loss   cls_loss    l1_loss  Instances       Size
